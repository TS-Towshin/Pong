...
player_speed = 10 # set it to 8 for normal mode and 10 for hard mode (in Player VS AI)
...
def reverse_dir(dir):       # dir = 0 to reverse x axis and 1 to reverse y axis
    ball.v[dir] *= -1
...
while running:
    ...
    if paused:
        ...
        clock.tick(12) # This is for optimization. When we pause the game, we don't have to change
                       ...
                       # the response time for the game to pause or unpause which is negligible
    pygame.display.flip()
